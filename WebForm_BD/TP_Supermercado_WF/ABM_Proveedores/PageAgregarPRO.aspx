<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageAgregarPRO.aspx.cs" Inherits="TP_Supermercado_WF.ABM_Proveedores.WebForm1" %>
    ...
    <div class="container">
        <div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <asp:TextBox ID="txtCuit" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="1" />
                </div>
            </div>
