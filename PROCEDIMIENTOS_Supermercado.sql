...
BEGIN
    BEGIN TRY
        ...
        -- Si no se pasa el monto, tomarlo del sueldo base registrado
        IF @Monto IS NULL
        ...
        INSERT INTO PagoSueldos (IdEmpleado, IdFormaPago, FechaPago, Monto)
        VALUES (@IdEmpleado, @IdFormaPago, @FechaPago, @Monto);

        -- En este punto se dispara el trigger TR_ControlPagoSueldos,
        -- que valida que no exista otro pago en el mismo mes/año.
